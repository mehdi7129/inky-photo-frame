...
class AlbumsApi:
    ...
    def get_all_albums(
        self,
        asset_id: Annotated[Optional[UUID], Field(description="Only returns albums that contain the asset Ignores the shared parameter undefined: get all albums")] = None,
