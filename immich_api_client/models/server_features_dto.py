...
class ServerFeaturesDto(BaseModel):
    ...
    trash: StrictBool
    __properties: ClassVar[List[str]] = ["configFile", "duplicateDetection", "email", "facialRecognition", "importFaces", "map", "oauth", "oauthAutoLaunch", "ocr", "passwordLogin", "reverseGeocoding", "search", "sidecar", "smartSearch", "trash"]
