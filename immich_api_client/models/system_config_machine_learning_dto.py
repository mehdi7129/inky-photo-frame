...
class SystemConfigMachineLearningDto(BaseModel):
    ...
    """ # noqa: E501
    availability_checks: MachineLearningAvailabilityChecksDto = Field(alias="availabilityChecks")
    clip: CLIPConfig
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "availabilityChecks": MachineLearningAvailabilityChecksDto.from_dict(obj["availabilityChecks"]) if obj.get("availabilityChecks") is not None else None,
