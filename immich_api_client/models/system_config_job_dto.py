...
class SystemConfigJobDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["backgroundTask", "faceDetection", "library", "metadataExtraction", "migration", "notifications", "ocr", "search", "sidecar", "smartSearch", "thumbnailGeneration", "videoConversion", "workflow"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ocr": JobSettingsDto.from_dict(obj["ocr"]) if obj.get("ocr") is not None else None,
            ...
            "workflow": JobSettingsDto.from_dict(obj["workflow"]) if obj.get("workflow") is not None else None
        })
        return _obj
