...
class SessionCreateDto(BaseModel):
    ...
    duration: Optional[Union[Annotated[float, Field(strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]]] = Field(default=None, description="session duration, in seconds")
