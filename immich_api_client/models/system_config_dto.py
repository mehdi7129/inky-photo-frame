...
class SystemConfigDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["backup", "ffmpeg", "image", "job", "library", "logging", "machineLearning", "map", "metadata", "newVersionCheck", "nightlyTasks", "notifications", "oauth", "passwordLogin", "reverseGeocoding", "server", "storageTemplate", "templates", "theme", "trash", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nightlyTasks": SystemConfigNightlyTasksDto.from_dict(obj["nightlyTasks"]) if obj.get("nightlyTasks") is not None else None,
