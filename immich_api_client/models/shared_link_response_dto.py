...
class SharedLinkResponseDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["album", "allowDownload", "allowUpload", "assets", "createdAt", "description", "expiresAt", "id", "key", "password", "showMetadata", "slug", "token", "type", "userId"]
