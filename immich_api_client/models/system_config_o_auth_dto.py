...
class SystemConfigOAuthDto(BaseModel):
    ...
    default_storage_quota: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(alias="defaultStorageQuota")
    enabled: StrictBool
    ...
    __properties: ClassVar[List[str]] = ["autoLaunch", "autoRegister", "buttonText", "clientId", "clientSecret", "defaultStorageQuota", "enabled", "issuerUrl", "mobileOverrideEnabled", "mobileRedirectUri", "profileSigningAlgorithm", "roleClaim", "scope", "signingAlgorithm", "storageLabelClaim", "storageQuotaClaim", "timeout", "tokenEndpointAuthMethod"]
