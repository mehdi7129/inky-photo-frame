...
class ServerConfigDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["externalDomain", "isInitialized", "isOnboarded", "loginPageMessage", "maintenanceMode", "mapDarkStyleUrl", "mapLightStyleUrl", "oauthButtonText", "publicUsers", "trashDays", "userDeleteDelay"]
