...
class OcrConfig(BaseModel):
    ...
    """ # noqa: E501
    enabled: StrictBool
    max_resolution: Annotated[int, Field(strict=True, ge=1)] = Field(alias="maxResolution")
    min_detection_score: Union[Annotated[float, Field(le=1, strict=True, ge=0.1)], Annotated[int, Field(le=1, strict=True, ge=1)]] = Field(alias="minDetectionScore")
    min_recognition_score: Union[Annotated[float, Field(le=1, strict=True, ge=0.1)], Annotated[int, Field(le=1, strict=True, ge=1)]] = Field(alias="minRecognitionScore")
