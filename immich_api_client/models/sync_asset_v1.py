...
class SyncAssetV1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["checksum", "deletedAt", "duration", "fileCreatedAt", "fileModifiedAt", "id", "isFavorite", "libraryId", "livePhotoVideoId", "localDateTime", "originalFileName", "ownerId", "stackId", "thumbhash", "type", "visibility"]
